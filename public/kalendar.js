let Kalendar = (function(){
    ...
    redovnaZauzeca.forEach(redovnoZauzece => {
        if(sala === redovnoZauzece.naziv && poklapanjeIntervalaImpl(pocetak, kraj, redovnoZauzece.pocetak, redovnoZauzece.kraj)){
    ...
    vanrednaZauzeca.forEach(vanrednoZauzece => {
        if(sala === vanrednoZauzece.naziv && poklapanjeIntervalaImpl(pocetak, kraj, vanrednoZauzece.pocetak, vanrednoZauzece.kraj)){
            ...
            if(mjesec === parseInt(danMjesecGodina[1]) - 1 && godina == danMjesecGodina[2])
            {
                //obicno == jer je godina broj, a ovo string
                //ubacena i provjera godine za vanredna
            var index = sedmica + parseInt(danMjesecGodina[0]) - 1;
            //dodala ovo
            dani[index].querySelector("div").classList.remove("slobodna");
    ...
    function poklapanjeIntervalaImpl(poc1, kraj1, poc2, kraj2)
	{
    ...
    poklapanjeIntervala: poklapanjeIntervalaImpl
    }
    }());
